...
public class HoundHelper implements PermissionRepository.PermissionResultCallback{
    ...
    private PermissionRepository permissionUtils;
    private final static int PLAY_SERVICES_REQUEST = 1000;
    private final static int REQUEST_CHECK_SETTINGS = 2000;
    public HoundHelper(Context context) {
        this.context=context;
        this.current_activity= (Activity) context;
        permissionUtils=new PermissionRepository(context,this);
